    ...
    $.fn.extend({
        addTooltip: function() {
            ...
            if (window.jQuery_YACSSTooltip_TT == undefined) {
                window.jQuery_YACSSTooltip_TT =  $('<div id="' + 'CSSTooltip' + Math.floor(Math.random()*(9999-999+1)+999) + '" class="YACSSTooltip" style="display: none; position: absolute; border: 1px solid #333; background-color: #138799; border-radius: 5px; padding: 5px; color: #fff; font-size: 16px;max-width:350px;line-break:auto;word-break:normal;word-break:break-word;overflow-wrap: break-word;word-spacing:0px;white-space:normal;text-align:center;overflow-wrap:normal;"></div>');
            ...
            this.hover(//On hover...
                function() {
                    ...
                    if(title)
                        $(this).removeAttr('data-info').data('data-info', title);
                    //Add tooltip
                    ttShown = true;
                ...
                function() {
                    ...
                    var title = $(this).data('data-info');
                    if (title)
                        $(this).attr('data-info', title).data('data-info', '');
